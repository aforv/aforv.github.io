...
<body>
	...
	<br>
    <div class="boxBOx">
		<h4>This page is not found! (404)
        </h4><h6>It may have been removed or it is been renamed to an another name.</h6>
        <div class="buttons">
            <button class="highlight" onclick="document.location='javascript:history.go(-1);'">Go Back</button>
            <button class="highlight" onclick="document.location='http://aversrestaurant.0fees.us/'">Home</button>
        </div>
		<hr>
    </div>
